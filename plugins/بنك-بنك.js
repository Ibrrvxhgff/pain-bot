        ...
        viewOnceMessage: {
            ...
            message: {
                ...
                interactiveMessage: {
                    ...
                    body: { text: response, subtitle: "𝙱𝙾𝚃-𝙷𝙰𝚁𝙾𝙽" },

                    header: {

                        hasMediaAttachment: true,

                        ...(await prepareWAMessageMedia({ image: { url: imageUrl } }, { upload: conn.waUploadToServer }, { quoted: null }))
